...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.isbroadcast'
        db.add_column(u'cosinnus_message_message', 'isbroadcast',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.isbroadcast'
        db.delete_column(u'cosinnus_message_message', 'isbroadcast')
    ...
    models = {
        ...
        u'cosinnus_message.message': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'isbroadcast': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
