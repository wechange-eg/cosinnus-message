...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.creator'
        db.add_column(u'cosinnus_message_message', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'cosinnus_message_message_set', null=True, on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Message.created'
        db.add_column(u'cosinnus_message_message', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.creator'
        db.delete_column(u'cosinnus_message_message', 'creator_id')

        # Deleting field 'Message.created'
        db.delete_column(u'cosinnus_message_message', 'created')
    ...
    models = {
        ...
        u'cosinnus_message.message': {
            'Meta': {'ordering': "[u'-created_on', u'title']", 'object_name': 'Message'},
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'message'", 'on_delete': 'models.PROTECT', 'to': u"orm['auth.User']"}),
