...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.created_on'
        db.delete_column(u'cosinnus_message_message', 'created_on')

        # Deleting field 'Message.author'
        db.delete_column(u'cosinnus_message_message', 'author_id')


    def backwards(self, orm):
        # Adding field 'Message.created_on'
        db.add_column(u'cosinnus_message_message', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 2, 18, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Message.author'
        # get any valid user id, will be overwritten by 0002 migration anyway
        valid_user_id = orm['auth.User'].objects.all()[0].id
        db.add_column(u'cosinnus_message_message', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=valid_user_id, related_name=u'message', on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)
    ...
    models = {
        ...
        u'cosinnus_message.message': {
            'Meta': {'ordering': "[u'-created', u'title']", 'object_name': 'Message'},
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'cosinnus_message_message_set'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['auth.User']"}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'cosinnus_message_message_set'", 'on_delete': 'models.PROTECT', 'to': u"orm['cosinnus.CosinnusGroup']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'recipients': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'messages'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
