...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.isprivate'
        db.add_column(u'cosinnus_message_message', 'isprivate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.isprivate'
        db.delete_column(u'cosinnus_message_message', 'isprivate')
